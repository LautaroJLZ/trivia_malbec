      ...
      <div className="bg-[url('../views/img/bg_bodega_rojo.jpg')] bg-cover bg-center ">
        ...
        <div className="flex flex-col justify-center items-center min-h-screen">
          <div className="w-[35%] backdrop-blur-sm bg-white/[.05] flex flex-col py-10 px-16 border border-white rounded-lg shadow-xl">
            ...
            <input id="username" type="text" className="text-red-800 border-2 border-white rounded py-2 px-5 my-2" />
            ...
            <Link href="/Init" className="bg-white text-red-700 rounded-md px-10 py-3 text-center my-10 text-xl hover:bg-red-500 hover:text-white transition-all duration-300 cursor-pointer">
              Iniciar Sesion 
            </Link>
          </div>
